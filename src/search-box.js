const SearchBox = ({ totalCount, pageCount, queryString, onPageLimitChange, onQueryChange }) => {
  return (
    <div className="d-flex align-items-center bg-light px-3 py-2 small rounded-3">
      <div className="d-flex align-items-center flex-grow-1">
        ...
        <input id="queryString" className="form-control form-control-sm me-2" type="text" value={queryString} onChange={(e) => onQueryChange(e.target.value)} />
      </div>
